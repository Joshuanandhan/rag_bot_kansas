...
python webscraper.py -f sample_urls.txt -o output_all -n kansas_dmv_web --recursive --same-domain

Advanced Recursive Crawling:
python webscraper.py -f sample_urls.txt -o output_all -n kansas_dmv_web --recursive --same-domain --depth 5 --delay 2

Non-Recursive (Original Mode):
python webscraper.py -f sample_urls.txt -o output_all -n kansas_dmv_web